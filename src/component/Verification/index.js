    ...
    <div className="w-full">
      <div className=" my-[3vw] border-2 border-black">
        <h1 className="text-black font-semibold  lg:text-[1.5vw] text-[1.4w]">
          Certificate Online Verify & Apply Online 2023
        </h1>
        <p className="text-black font-normal lg:text-[1.2vw] text-[1vw]">
          The Verification section of SarkariResult.Com is a very important page
          as you all know that Sarkari Result is a very important website which
          gives job and admission related information from time to time, but due
          to user demand apart from job and admission. Some information is given
          in this section like whether your domicile certificate is correct or
          not, how to check it online, income certificate, caste certificate,
          aadhar card download, status view, how and where the correction will
          be done, PAN card online Application, voter id card status and online
          application, information of khasra khatauni of maken and how to
          download khatauni. This is an important information which is useful
          for everyone.
        </p>
      </div>
