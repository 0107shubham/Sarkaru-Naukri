...
const FAQ = () => {
  return (
    <div className="w-full border-2 border-[#D2691E] ">
      <div className="text-center space-y-6 w-full border-2 border-[#D2691E]">
        <div className="bg-[#AB183D] text-white text-[2vw]  lg:text-[1.8vw] w-full">
          <p>
            Sarkari Result : Resources to Help Indians Get Government Jobs
            (Sarkari Job)
          </p>
        </div>
      ...
      <div className="text-center space-y-6">
        ...
        <p className="text-[2vw]">
          ...
          even teaching. Some of the more highly-paid and in-demand positions
          are discussed below to give you a sense of their requirements and
          salary expectations.
        </p>
        <ol className="text-left list-decimal mx-6">
          <li className="text-[2vw]">
            ...
            government, collecting revenue, and supervising public spending. An
            IFS officer manages foreign relations in India with more than 160
            Indian Diplomatic Missions and International Organizations around
          ...
          <li className="text-[2vw]">
            ...
            branches including the Research and Analysis Wing (R&AW),
            Intelligence Bureau (IB), Central Bureau of Investigation (CBI), and
            Criminal Investigation Department (CID). To be eligible for a job
            with IPS, there are additional requirements, including physical
            standards. According to Payscale, an entry-level police constable
            with less than 1-year experience can earn an average total
          ...
          <li className="text-[2vw]">
            ...
            Allahabad Bank, HDFC, and ICICI are highly sought after. A job in
            the banking sector could either be a clerical position such as
            typists, data entry operators, cashiers, or clerks or a probationary
            officer (PO) role. As a PO, the candidate will be under probation
            during the training period and will be hired following the probation
            based on performance. During the training period, the candidate will
            be trained in accounting, finance, billing, investment, and revenue
            collection. A PO role allows opportunities for career growth to
            middle and senior management based on performance and additional
          ...
          <li className="text-[2vw]">
            ...
            physical, and vision standards. Cadet trainees receive a stipend of
            INR 56,100 per month. Allowances and promotions will increase this
            salary. There are also several agricultural, engineering, and
            research jobs with their own set of rules and requirements. These
            can get very complicated, but Sarkari Result does all the work for
            you and lists the various jobs ranging from a Rajasthani police
            constable to Allahabad High Court Review Officer. Each job posting
            contains all the details you would need to be able to apply for the
            position with ease.
          </li>
        </ol>
      </div>
      <div className="text-center space-y-6">
        ...
        <ul className="text-left list-disc mx-6">
        ...
        <p className="text-[2vw]">Eligibility Requirements</p>
        <p className="text-[2vw]">
        ...
        <p className="text-[2vw]">Important Dates</p>
        <p className="text-[2vw]">
        ...
        <p className="text-[2vw]">There are several important dates to note:</p>
        <ul className="text-left list-disc mx-6">
      ...
      <div className="text-center space-y-6">
        ...
        <p className="text-[2vw]">
          ...
          these. ‘Sarkari Naukri’ is a dream for millions of people across the
        ...
        <p className="text-[2vw]">
          ...
          through multiple levels of tests. These include a written examination,
          interview and sometimes even physical examination. These are
          competitive exams, and millions of people appear for these exams to
          get into a coveted Government job.
        </p>
      </div>
      ...
      <div className="text-center space-y-6">
        ...
        <p className="text-[2vw]">
          ...
          32,000 jobs. There was a similar drop in 2021 of almost 107,000 people
          hired by the state government. This creates an extremely competitive
          environment. Getting up-to-date information on the latest jobs on
          Sarkari Result and understanding eligibility requirements can help you
          stand out from the crowd. These are of course some of the most coveted
          roles in India and are extremely competitive.
        </p>
      </div>
      <div className="text-center space-y-6">
        <p className="bg-[#AB183D] text-white text-[2.4vw]  lg:text-[1.8vw] w-full">
        ...
        <p className="text-[2vw]">
          ...
          depending on their qualifications. Group A mostly comprises of
          managerial roles and are considered to be the highest level of jobs.
          Group B is for Gazetted officers. To clear the Group B exam, one has
          to make the UPSC exam. Most seats under Group B are filled via
          promotions, so only limited seats are left for entrance via exam.
          Group C and D are for public servants who have non-supervisory roles.
        </p>
      </div>
      ...
      <div className="text-center space-y-6">
        ...
        <p className="text-[2vw]">
          ...
          Government exams and Sarkari Result.
        </p>
      </div>
      ...
      <div className="text-center space-y-6 w-full">
        ...
        <p className="text-[2vw]">
          ...
          Sarkari info for the Sarkari Result in Jharkhand can be searched
          online for all the exams conducted for the state of Jharkhand. UP
          Sarkari result is one of the most common online searches in India,
          considering the high demand for Government jobs in the state of U.P.
        </p>
      </div>
    </div>
  );
